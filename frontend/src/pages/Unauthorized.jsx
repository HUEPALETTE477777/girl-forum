...
const Unauthorized = () => {
    return (
        <div className="flex text-2xl bg-red-400 min-h-screen">
            <div className="flex flex-col">
                <h1>LOGIN OR CREATE AN ACCOUNT! SESSION CLEAR!</h1>
                <a href="https://www.youtube.com/watch?v=24gVmFKZwu0" target="_blank" className="text-blue-900 hover:text-amber-800">CLICK FOR FUN!</a>
                <p>
                    [Verse 1]
